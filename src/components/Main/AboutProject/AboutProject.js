        ...
        <section className='about' id='about-project'>
            <div className='about__container'>
                ...
                <div className='about__time'>
                    <div className='about_time-oneweek'><p className='about__time-text'>1 неделя</p></div>
                    <div className='about_time-fourweeks'><p className='about__time-text'>4 недели</p></div>
                    <p className='about_time-back'>Back-end</p>
                    <p className='about_time-front'>Front-end</p>
                </div>
